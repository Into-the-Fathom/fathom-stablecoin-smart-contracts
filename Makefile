...
checkProxyWallet:
	...
	coralX execute --network apothem --path scripts/tests/0_makeWallet/2_makeWallet.js
...
dexIntegration:
	...
	#for WXDC
	coralX execute --network apothem --path scripts/deployment/26_fathom-oracle-price-feed/deploy/fathom-oracle-price-feedWXDC.js
	coralX execute --network apothem --path scripts/deployment/26_fathom-oracle-price-feed/initialize/initialize_fathom-oracle-price-feedWXDC.js

	#for FTHM
	# coralX execute --network apothem --path scripts/deployment/26_fathom-oracle-price-feed/deploy/fathom-oracle-price-feedFTHM.js
